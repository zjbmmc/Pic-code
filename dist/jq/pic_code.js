...
var pic_code = {
    ...
    create_div: function() {
        ...
        oDiv1.css({
            'width': pic_code._opt.crop_div + pic_code._opt.unit,
            'height': pic_code._opt.crop_div + pic_code._opt.unit,
            'position': 'absolute',
            'left': oD_left + pic_code._opt.unit,
            'top': oD_top + pic_code._opt.unit,
            'background': '#fff',
        ...
        oDiv2.css({
            ...
            'height': pic_code._opt.crop_div + pic_code._opt.unit,
            'position': 'absolute',
            'left': pic_code.params.left_begin + 'px',
            'top': oD_top + pic_code._opt.unit
        });
        oDiv2.css({
            'background': 'url(' + pic_code.dom_obj.oPic.find('img').attr('src') + ')',
            'background-position': '-' + oD_left + pic_code._opt.unit + ' -' + oD_top + pic_code._opt.unit,
            'background-size': pic_code._opt.div_width + pic_code._opt.unit + ' ' + pic_code._opt.div_height + pic_code._opt.unit,
            'box-shadow': '0px 0px 3px 3px yellow inset,0px 0px 3px 3px #000'
        });
        if (pic_code.params.agent) {
